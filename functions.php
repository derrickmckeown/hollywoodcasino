...
function theme_name_scripts() {
	wp_enqueue_script( 'countdown', get_template_directory_uri() . '/js/jquery.countdown.js', array(), '1.0.0', true );
}
...
function scaffolding_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'hp-contact',
		'name' => __('Homepage Contact Box', 'scaffolding'),
		'description' => __('This is used for your contact information on the homepage.', 'scaffolding'),
	...
	register_sidebar(array(
		'id' => 'cta1',
		'name' => __('Call To Action Left', 'scaffolding'),
		'description' => __('This is used for your CTA information on the homepage.', 'scaffolding'),
		'before_widget' => '<div id="%1$s" class="hp-widget %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'id' => 'cta2',
		'name' => __('Call To Action Middle', 'scaffolding'),
		'description' => __('This is used for your CTA information on the homepage.', 'scaffolding'),
		'before_widget' => '<div id="%1$s" class="hp-widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
	...
	register_sidebar(array(
		'id' => 'cta3',
		'name' => __('Call To Action Right', 'scaffolding'),
		'description' => __('This is used for your CTA information on the homepage.', 'scaffolding'),
		'before_widget' => '<div id="%1$s" class="hp-widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
...
define( 'CUSTOM_POST_TYPE', 'events' );
define( 'CUSTOM_TAXONOMY_CAT', 'events_cat' );
define( 'CUSTOM_TAXONOMY_TAG', 'events_tag' );
...
function scaffolding_custom_post_example() {
	...
	register_post_type( CUSTOM_POST_TYPE,
		...
		array(
			'labels' => array(
				...
				'search_items'       => __( 'Search Event Type', 'scaffolding' ),               // Search Custom Type Title
			...
			'hierarchical'        => false,
			'has_archive'         => 'events',           // you can rename the archive slug here
			'rewrite'	          => array(
	...
	register_taxonomy( CUSTOM_TAXONOMY_CAT,
		...
		array(
			...
			'labels' => array(
				'name'              => __( 'Event Categories', 'scaffolding' ),        // name of the custom taxonomy
				...
				'edit_item'         => __( 'Edit Event Category', 'scaffolding' ),     // edit custom taxonomy title
	...
	register_taxonomy( CUSTOM_TAXONOMY_TAG,
		...
		array(
			...
			'labels' => array(
				'name'              => __( 'Event Tags', 'scaffolding' ),        // name of the custom taxonomy
				...
				'edit_item'         => __( 'Edit Event Tag', 'scaffolding' ),    // edit custom taxonomy title
